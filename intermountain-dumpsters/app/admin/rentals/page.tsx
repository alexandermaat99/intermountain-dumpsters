...
import { Loader2, Calendar, MapPin, User as UserIcon, Package, DollarSign, Truck } from 'lucide-react';
          ...
          {rentalsLoading ? (
            ...
            <div className="flex flex-col gap-4">
              {rentals.length === 0 ? (
                ...
                rentals.map((rental) => (
                  <Card key={rental.id} className="hover:shadow-md transition-shadow w-full">
